/*
 * This file was created by Massimo Ceraolo of the University of Pisa
 *
 * THIS SOFTWARE IS PROVIDED UNDER THE TERMS OF GPL VERSION 3 LICENSE
 * ANY USE, REPRODUCTION OR DISTRIBUTION OF THIS PROGRAM CONSTITUTES RECIPIENT'S 
 * ACCEPTANCE OF THE GPL VERSION 3 LICENSE.
 *
 * THIS SOFTWARE ID SUPPLIED "AS-IS"
 * THE AUTHOR OFFERS NO WARRANTY OF ITS FITNESS FOR ANY PURPOSE WHATSOEVER, 
 * AND ACCEPTS NO LIABILITY WHATSOEVER FOR ANY LOSS OR DAMAGE INCURRED BY ITS USE.
 */
﻿package PowerLineMC
